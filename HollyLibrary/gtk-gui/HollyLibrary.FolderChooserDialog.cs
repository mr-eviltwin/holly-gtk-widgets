...
namespace HollyLibrary
{
	public partial class FolderChooserDialog
	{
		...
		protected virtual void Build ()
		{
			...
			this.FolderTree = new global::HollyLibrary.HTreeView ();
			...
			this.FolderTree.ButtonPressEvent += new global::Gtk.ButtonPressEventHandler (this.OnFolderTreeButtonPressEvent);
			this.FolderTree.CursorChanged += new global::System.EventHandler (this.OnFolderTreeCursorChanged);
			this.FolderTree.RowActivated += new global::Gtk.RowActivatedHandler (this.OnFolderTreeRowActivated);
			this.FolderTree.BeforeNodeExpand += new global::HollyLibrary.NodeEventHandler (this.OnFolderTreeBeforeNodeExpand);
